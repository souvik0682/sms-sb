    ...
    public partial class ManageCompany : System.Web.UI.Page
    {
        ...
        protected void gvwUser_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                e.Row.Cells[1].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "CompType"));
                e.Row.Cells[2].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "CompName"));
                e.Row.Cells[3].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "Country"));
                e.Row.Cells[4].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "StateName"));
                e.Row.Cells[5].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "City"));
                e.Row.Cells[6].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "PIN"));
                e.Row.Cells[7].Text = Convert.ToString(DataBinder.Eval(e.Row.DataItem, "CompPhone"));
        ...
        private void SetAttributes()
        {
            if (!IsPostBack)
            {
                txtWMECompName.WatermarkText = ResourceManager.GetStringWithoutName("ERR00032");
                txtWMEContactPerson.WatermarkText = ResourceManager.GetStringWithoutName("ERR00033");
        ...
        private void LoadCompany()
        {
            if (!ReferenceEquals(Session[Constants.SESSION_SEARCH_CRITERIA], null))
            {
                ...
                if (!ReferenceEquals(searchCriteria, null))
                {
                    ...
                    gvwUser.DataSource = userBll.GetAllCompanyList(searchCriteria);
                    gvwUser.DataBind();
                }
            }
        }
        ...
        private void RedirecToAddEditPage(int id)
        {
            ...
            Response.Redirect("~/View/AddEditCompany.aspx?id=" + encryptedId);
        }
        ...
        private void BuildSearchCriteria(SearchCriteria criteria)
        {
            ...
            criteria.UserName = (txtCompName.Text == ResourceManager.GetStringWithoutName("ERR00032")) ? string.Empty : txtCompName.Text.Trim();
            criteria.FirstName = (txtContactPerson.Text == ResourceManager.GetStringWithoutName("ERR00033")) ? string.Empty : txtContactPerson.Text.Trim();
        ...
        private void RetrieveSearchCriteria()
        {
            ...
            if (!ReferenceEquals(Session[Constants.SESSION_SEARCH_CRITERIA], null))
            {
                ...
                if (!ReferenceEquals(criteria, null))
                {
                    ...
                    {
                        txtCompName.Text = criteria.UserName;
                        txtContactPerson.Text = criteria.FirstName;
